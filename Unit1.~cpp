...
void __fastcall TForm1::Timer_ballTimer(TObject *Sender)
{
        ...
        ball->Top + ball->Height / 2 > paddleLeft->Top + paddleLeft->Height)))
        {
                ...
                Label2->Visible = true;
                Label3->Caption = "Iloœæ odbiæ: "+ IntToStr(numberOfBallBounces);
                Label3->Visible = true;
...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
   ...
   "Lewy gracz steruje paletk¹ klawiszami A(góra) i Z (dó³).\n"
   "Prawy gracz steruje paletk¹ za pomoc¹ strza³ek góra i dó³. \n\n"

   "Dla urozmaicenia zabawy:\n"
   "Kiedy obijesz pi³kê na œrodku paletki, wówczas zmienisz jej k¹t odbicia i pi³ka przyœpieszy.\n"
